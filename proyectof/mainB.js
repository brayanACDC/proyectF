...
function filterProducts() {
  ...
  const filteredProducts = products.filter((product) => {
    ...
    const matchesAvailability =
      availability === "" || product.disponibilidad.toString() === availability;
    const matchesName = product.nombre_libro.toLowerCase().includes(name);

    return matchesCategory && matchesAvailability && matchesName;
  });
